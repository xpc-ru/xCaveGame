#ifndef GSOCKET_H__EDE4ADBD_0FD7_4b88_894D_C8460323A912__INCLUDED
#define GSOCKET_H__EDE4ADBD_0FD7_4b88_894D_C8460323A912__INCLUDED
...
public:
	...
	//
	int AcceptClientConnection(GSocket *pgSocketClient, int iWaitSec = 0);
	...
	//   true : closed
	//   false: opened
	inline const bool isClosed() { return bClosed; }
...
private:
	...
	GSOCKET_HANDLE* m_gSocket;
	std::string m_sLocalAddr;
	std::string m_sRemoteAddr; // Used in socket created with CreateClient.
};


#endif // ndef GSOCKET_H__EDE4ADBD_0FD7_4b88_894D_C8460323A912__INCLUDED
